          ...
          <div class="flex gap-5 items-stretch w-full">
            ...
            <div class="col-span-11 w-full ">
              ...
              <p>
                ...
                adequate information that allows us to collaborate and execute effectively
                and efficiently.
              </p>
            </div>
          </div>
          <div class="flex gap-5 items-stretch w-full">
            ...
            <div class="col-span-11 w-full">
              ...
              <p>
                ...
                strategies that are borderless yet adaptable to local customs and
                contexts.
              </p>
            </div>
          </div>
          <div class="flex gap-5 items-stretch w-full">
            ...
            <div class="col-span-11 w-full ">
              ...
              <p>
                ...
                understand that an inspired workforce is the foundation of a thriving
                company.
              </p>
            </div>
          </div>
